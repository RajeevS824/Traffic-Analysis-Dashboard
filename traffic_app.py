...
Original file is located at
    https://colab.research.google.com/drive/18WnIqTs9kl3TxUDK-RPi8qtes98t2IjK
...
queries = {
    ...
    "Violations are most common among younger drivers (<25)": """
        select violation,count(*)as most_violations
        from traffic_records
        where driver_age < 25
        group by violation
        order by most_violations desc;
